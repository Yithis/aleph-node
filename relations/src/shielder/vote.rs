    ...
    fn generate_constraints() {
        ...
        let bases = [
            ark_bls12_381::G1Affine::deserialize_compressed(
                &[
                    131u8, 243, 22, 251, 27, 15, 154, 154, 252, 137, 52, 42, 231, 183, 121, 207,
                    68, 95, 68, 69, 244, 238, 227, 27, 58, 108, 44, 150, 223, 140, 129, 232, 31,
                    152, 214, 153, 240, 95, 130, 13, 132, 10, 101, 131, 236, 124, 12, 44,
                ][..],
            )
            .unwrap(),
            ark_bls12_381::G1Affine::deserialize_compressed(
...
mod tests {
    ...
    fn vote_proving_procedure() {
        let circuit_without_input = VoteRelationWithoutInput::new(MAX_PATH_LEN);
